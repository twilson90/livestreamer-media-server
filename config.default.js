export default {
	...
	"media-server.media_expire_time": 24 * 60 * 60,
	"media-server.media-cleanup-interval": 1 * 60 * 60,
	...
	"media-server.use_hardware": false,
	"media-server.use_hevc": false,
